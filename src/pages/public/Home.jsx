  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center md:mr-10">
        ...
        <h1 className="text-3xl md:text-6xl font-light font-inter text-shadow-lg mb-4 md:mb-6 whitespace-nowrap uppercase tracking-widest">Welcome to Shoppex</h1>
        
        <p className="text-sm md:text-xl text-shadow-lg font-inter ">Browse our latest collections.</p>        
