    ...
    ">
      ...
      <div className="relative group">
        ...
        <div className="text-center space-y-1.5 md:space-y-3">
            <h1 className="font-inter font-bold text-3xl md:text-5xl text-white">
                Aman Shahi
            </h1>
          ...
          ">
            ...
            <span className="text-pink-400 font-semibold block mt-2 mb-2 md:mb-4 text-lg md:text-2xl font-inter">
