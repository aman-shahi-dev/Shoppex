...
function Navbar() {
    ...
    return (
        <header className="w-full border-b bg-navbarBackground text-foreground font-inter">
            ...
            <div className='max-w-6xl mx-auto px-4 h-16 flex items-center justify-between '>
                ...
                <nav className='hidden md:flex md:items-center md:mt-2 md:justify-center gap-10 font-inter'>
                    <Link 
                        to='/' 
